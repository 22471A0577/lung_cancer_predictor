...
Users enter age, gender, and other health features

Real-time prediction with a risk meter visualizing the risk percentage
...
Includes Google Colab code, dataset, trained model (.pkl), and web files
